...
ROUTE_DEFINITIONS: dict[str, dict[str, Any]] = {
    "analysis": {
        ...
        "summary_surfaces": ["triage_repo_request", "show_runtime_preflight", "show_workspace_context_pack", "show_context_structure", "search_context_index", "run_analysis_audit"],
        "primary_paths": [
    ...
    "verification": {
        ...
        "summary": "Resolve semantic checks, auth profiles and sessions, helper bundle sync, verification plans, runs, baselines, and artifacts.",
        "tags": ["auth", "baseline", "helper bundle", "semantic", "session", "verification", "visual"],
        "triggers": ["auth profile", "auth session", "baseline", "playwright", "semantic", "verification", "visual"],
    ...
    "plugin-dev": {
        ...
        "summary": "Orient on plugin source, low-token retrieval surfaces, payload ceilings, benchmark telemetry, context-pack cache behavior, dashboard performance budgets, auth profiles and sessions, project memory, learnings, MCP interfaces, scripts, catalogs, and self-host development surfaces.",
        "tags": [
            "analytics",
            "auth",
            "benchmark",
        ...
        "summary_surfaces": ["get_plugin_stats", "get_dashboard_snapshot", "triage_repo_request", "show_capability_catalog", "show_runtime_preflight"],
        "primary_paths": [
            "skills/plugin-platform/SKILL.md",
            "references/command-surface.md",
            "README.md",
...
SCRIPT_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary": "Installs the plugin into a home-local plugins directory, refreshes the active Codex cache copy, updates marketplace metadata, and can place a global `agentiux` launcher into PATH.",
        ...
        "cost_hint": "low",
        "related_routes": ["plugin-dev", "release"],
        "safe_usage": "Copies tracked plugin files to the install root, refreshes the active Codex cache when available, updates local marketplace metadata, and optionally writes a user-local command shim.",
        "common_flags": [
            "--source-plugin-root",
            "--install-root",
            "--marketplace-path",
