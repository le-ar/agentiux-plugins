...
SCRIPT_DEFINITIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "summary": "Installs the plugin into a home-local plugins directory and updates marketplace metadata.",
        ...
        "cost_hint": "low",
        "related_routes": ["plugin-dev", "release"],
        "safe_usage": "Copies tracked plugin files to the install root and updates local marketplace metadata.",
        "common_flags": ["--plugin-root", "--install-root", "--marketplace-path"],
        "produced_artifacts": ["installed plugin copy", "install-metadata.json", "marketplace.json"],
    },
]
