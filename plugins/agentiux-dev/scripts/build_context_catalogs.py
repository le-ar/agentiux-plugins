...
ROUTE_DEFINITIONS: dict[str, dict[str, Any]] = {
    ...
    "plugin-dev": {
        ...
        "summary": "Orient on plugin source, auth profiles and sessions, project memory, learnings, MCP interfaces, scripts, catalogs, and self-host development surfaces.",
        "tags": ["analytics", "auth", "catalog", "dashboard", "mcp", "memory", "plugin", "python", "self-host", "session"],
        "triggers": ["auth profile", "auth session", "catalog", "learning entry", "mcp", "plugin", "project memory", "python scripts", "self-host"],
