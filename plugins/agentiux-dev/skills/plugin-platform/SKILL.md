...
3. Validate Python compile health, MCP tool discovery, dashboard health, and smoke coverage before claiming the plugin is ready.
4. Keep source and installed-copy paths distinct; repo-tracked files stay public-safe while home-local install behavior remains external.
5. When operator UX, commands, or verification behavior changes, update the plugin README in the same work cycle.
